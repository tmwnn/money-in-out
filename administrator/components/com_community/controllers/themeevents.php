...
class CommunityControllerThemeevents extends CommunityController
{
    ...
    public function apply()
    {
        ...
        {
            $mainframe->redirect( 'index.php?option=com_community&view=themeevents' , JText::_( 'COM_COMMUNITY_PERMISSION_DENIED' ) , 'error');
        }
        ...
        $mainframe->redirect( 'index.php?option=com_community&view=themeevents' , $message, 'message' );
    }
}