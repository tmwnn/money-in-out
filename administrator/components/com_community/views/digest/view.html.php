 ...
 */
class CommunityViewDigest extends JViewLegacy
{
	/**
	...
	public function display( $tpl = null )
	{
		...
		JToolBarHelper::title( JText::_('COM_COMMUNITY_DIGEST'), 'digest' );
	...
	public function setToolBar()
	{
		...
		// Set the titlebar text
		JToolBarHelper::title( JText::_('COM_COMMUNITY_DIGEST'));

		// Add the necessary buttons
		JToolBarHelper::save( 'digest.apply', JText::_('COM_COMMUNITY_SAVE') );
	}
}
