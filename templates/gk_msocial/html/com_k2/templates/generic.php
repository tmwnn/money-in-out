...
<section id="k2Container" class="genericView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
		...
		<div class="itemList">
				...
				<article>							
					...
					<header<?php if(!$this->params->get('genericItemDateCreated')): ?> class="nodate"<?php endif; ?>>
							...
							<ul>
								...
								<li class="date-hidden"><time datetime="<?php echo JHtml::_('date', $item->created, JText::_(DATE_W3C)); ?>"><?php echo JHTML::_('date', $item->created, JText::_('F j Y')); ?></time></li>
								<?php endif; ?>
							</ul>
							<?php endif; ?>
