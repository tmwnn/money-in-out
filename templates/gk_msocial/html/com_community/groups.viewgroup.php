...
<div class="js-focus">
	<div class="js-focus-cover">
		<img id='<?php echo $group->id; ?>' class="focusbox-image cover-image" src="<?php echo $group->getCover(); ?>" alt="cover photo">
		<div class="js-focus-gradient" data-cover-context="group" data-cover-type="cover"></div>

			<?php if($isAdmin || $isSuperAdmin || $isMine) { ?>
				<!-- Change cover button -->
				<div class="js-focus-change-cover btn" onclick="joms.cover.select(this, <?php echo $group->id; ?>);" data-cover-context="group" data-cover-type="cover">
					<i class="js-icon-picture"></i><?php echo JText::_('COM_COMMUNITY_CHANGE_COVER'); ?>
				</div>
			<?php }?>
		  ...
		  <div class="navbar-inner">
		      ...
		      <div class="nav-collapse collapse js-collapse">
		        <ul class="nav">
					...
					<?php if($config->get('enablereporting') == 1){?>
				...
				<div class="cTabsContent  <?php if($isMember || $isSuperAdmin || !$config->get('lockgroupwalls')) {echo 'cTabsContentCurrent';} ?>">
					...
					<div class="cActivity cGroup-Activity" id="activity-stream-container">
						...
						<div class="cActivity-LoadMore joms-newsfeed-more" id="activity-more">
	                        <a class="more-activity-text button" href="javascript:void(0);" onclick="joms.activities.more();">
