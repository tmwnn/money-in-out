...
<section>
          <article>
                    <header>
                              <h1><?php echo JText::_('TPL_GK_LANG_ERROR_INFO'); ?> </h1>
                    </header>
                    <h2><?php echo $this->error->getCode(); ?></h2>
          </article>
</section>
<footer>
          <p><?php echo JText::_('TPL_GK_LANG_ERROR_DESC'); ?></p>
          <p><a href="<?php echo JURI::base(); ?>" title="<?php echo JText::_('JERROR_LAYOUT_GO_TO_THE_HOME_PAGE'); ?>"><?php echo JText::_('JERROR_LAYOUT_HOME_PAGE'); ?></a> /
