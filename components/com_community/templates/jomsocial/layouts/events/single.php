            ...
            <div class="joms-module__wrapper">
                ...
                <div id="joms-app--event-series" class="joms-tab__content" style="display:none;">
                    <div id="community-event-series">
                        ...
                        <?php } ?>
                        <div class="joms-gap"></div>
                        <a href="<?php echo CRoute::_('index.php?option=com_community&view=events&task=display' . $grouplink . '&parent=' . $event->parent);?>" class="joms-button--link"><?php echo JText::_('COM_COMMUNITY_EVENTS_VIEW_SERIES'). '(' . $seriesCount . ')';?></a>
                    </div>
