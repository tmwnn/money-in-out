                    ...
                    func: function(params, tbw){
                        ...
                        var $modal = tbw.openModalInsert(
                            ...
                            function(){
                                ...
                                if (tbw.isTextarea && tbw.$ta) {
                                    var extra = tbw.$ta.data();
                                    for (var prop in extra) {
                                        if (prop.match(/^wysiwyg.+/)) {
                                            data.append(prop.replace(/^wysiwyg/, '').toLowerCase(), extra[prop]);
                                        }
                                    }
                                }
                                ...
                                $.ajax({
                                    ...
                                    success: function(data){
                                        if(data.photo_id) {
                                            tbw.execCmd('insertImage', data.thumb_url.replace('thumb_', 'original_'));
                                            setTimeout(function(){
                                                tbw.closeModal();
                                            }, 250);
                                        } else {
